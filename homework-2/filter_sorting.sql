...
select sum(shipped_date - order_date) / count(ship_country) as average_quantity_days from orders
where ship_country = 'Germany' and shipped_date - order_date is not null
